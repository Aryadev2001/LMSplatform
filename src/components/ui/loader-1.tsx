/**
 * Pencil loader — a self-contained animated SVG (no props/state required).
 * The motion + palette live in globals.css under the `.pencil*` classes.
 * Concept credit: the "Pencil" CSS loader by Jon Kantner.
 */
export const PencilLoader = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      width="200px"
      viewBox="0 0 200 200"
      className={className ? `pencil ${className}` : "pencil"}
      role="img"
      aria-label="Loading"
    >
      <defs>
...
/** Back-compat alias for the original snippet's `import { Component }`. */
